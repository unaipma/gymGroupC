namespace Gimnasio
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.bConexionTest = new System.Windows.Forms.Button();
			...
			// bConexionTest
			// 
			this.bConexionTest.Location = new System.Drawing.Point(110, 336);
			this.bConexionTest.Name = "bConexionTest";
			this.bConexionTest.Size = new System.Drawing.Size(213, 23);
			this.bConexionTest.TabIndex = 4;
			this.bConexionTest.Text = "TestConnection";
			this.bConexionTest.UseVisualStyleBackColor = true;
			this.bConexionTest.Click += new System.EventHandler(this.bConexionTest_Click);
			// 
			// Form1
			// 
			...
			this.Controls.Add(this.bConexionTest);
		...
		private System.Windows.Forms.Button bConexionTest;
	}
}
